...
from fcnn import get_tiny_model, get_small_model, get_large_model, get_reg_model, compile_and_fit
...
def main(argv):
    ...
    models = { "tiny" : get_tiny_model(inputs=inputs, n_outputs=args.n_classes, drop_out=args.drop_out),
                ...
                "reg" : get_reg_model(inputs=inputs, n_outputs=args.n_classes, drop_out=args.drop_out)}
